...
const checkSidebarAndInitAd = setInterval(() => {
    ...
    if (adContainer) {
        ...
        // 랜덤 광고 목록
    const ads = [
        { title: "효빈지하철 2호선 하루빈과 함께!", img: "이미지/하루빈 2호선래핑.png", link: "효빈도시철도.html" },
        { title: "제17회 효빈 애니메이션 페스티벌", img: "이미지/HAF2026포스터.png", link: "HAF.html" },
        { title: "박효빈 시장의 발전 계획", img: "이미지/효빈광역시청.png", link: "박효빈.html" },
        { title: "즐거운 일상의 시작, 효빈교통공사!", img: "이미지/효빈광역시광고.png", link: "효빈교통공사.html" },
        { title: "제작진이 WD-40을 들이마시고 만든 쁘띠 레일루미네!", img: "이미지/쁘띠레일루미네.png", link: "쁘띠 레일루미네.html" },
{ title: "펜타곤시티 입주민 모집: 길 잃을 걱정 없는 5각형의 미학", img: "이미지/펜타곤시티.png", link: "산곡건설.html" },
    { title: "철근보다 감성을 붓습니다. 산곡건설, 당신의 로망을 시공합니다.", img: "이미지/산곡건설.png", link: "산곡건설.html" },
    { title: "스퀘어시티 입주 시작: 세상에서 가장 완벽한 폴리곤을 소유하세요.", img: "이미지/스퀘어시티.png", link: "산곡건설.html" },
    { title: "HUDC의 아파트가 지겨울 때, 튼튼한 기하학의 산곡건설", img: "이미지/산곡건설_로고.png", link: "산곡건설.html" },
    { title: "80년의 궤적, 1mm의 오차 없는 철도 부품 기술의 정점", img: "이미지/회주기업_사옥.png", link: "회주공업.html" },
{ title: "글로벌 인재와 실무 기술의 만남, 대찬대학교", img: "이미지/대찬대학교.png", link: "대찬대학교.html" },
{ title: "당신의 최애가 달립니다! 칠양여객 이타샤 버스", img: "이미지/시즈쿠간선버스.png", link: "칠양여객.html" },
       { 
    title: "【신규 역장 특전】 지금 접속 시 무료 300연차 & 사능동 소금빵 500개 지급! 리세마라 0티어 [UR 골든 아워 박라미] 확정 획득 찬스!", 
    img: "이미지/레일루미네_스마일_페스티벌.png", 
