...
const randomNotices = [
    ...
    { id: "r5", title: "[안내] 윤대환 전 시장 재판 결과 요약본 작성 가이드라인", content: "윤대환 전 시장 비위 문서는 명예훼손 소지가 큽니다. 효빈위키식 맹비난 드립을 배제하고 법원 판결문 원문에 기반하여 건조한 어조(NPOV)로 작성하십시오. <del>물론 시민들 속 터진 건 사실이지만</del>" },
    ...
    { id: "r33", title: "[안내] 2세대 두청운수 갈색(똥색) 버스 흑역사 묘사 허용", content: "2003~2007년 운행된 두청운수 버스 문서에 한해, 당시 75인승 과적과 <del>척추를 부수는 플라스틱 시트</del>의 고통을 생생하게 묘사하는 효빈위키식 취소선 드립 서술을 예외적으로 대폭 허용합니다." },
    ...
    { id: "r70", title: "[공지] 이미지 업로드 시 '한국어 단어.webp' 통일 재강조", content: "효빈시 관내 지하철역, 버스 사진 등을 업로드할 때는 무조건 '이미지/한국어 단어 이름.webp' 규칙을 철저히 준수해야 합니다. 영문명이나 webp 포맷 업로드 시 엑스박스를 유발하므로 즉시 삭제 처리됩니다." },
