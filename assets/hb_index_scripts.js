...
const randomNotices = [
    ...
    { id: "r80", title: "[모집] 빈주 1호선(황금색, #CFBA0F) 및 2호선(보라색, #C455F6) 환승 가이드", content: "빈주권 광역전철과 직결되는 빈주 1호선 마스코트 박빛나, 빈주 2호선 김소빈이 안내하는 환승역 동선 및 승강장 구조도를 상세하게 작성해 주실 광역 철도망 덕후를 모집합니다." },
