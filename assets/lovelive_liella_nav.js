document.addEventListener("DOMContentLoaded", () => {
    const container = document.getElementById("lovelive-liella-nav-container");
    if (!container) return;
    ...
    // 2. 방대한 HTML 구조 주입 (리엘라 멤버 박스 + 전체 시리즈 틀)
    const navHtml = `
        <!-- [리엘라 멤버 목록 표 박스] -->
                ...
                <div class="mb-4">
                    ...
                    <div class="flex justify-evenly flex-wrap gap-2 text-[11px] font-bold">
                        <a href="시부야 카논.html" class="w-[28%] sm:w-[18%] flex flex-col items-center wiki-link hover:no-underline">
                            <img src="이미지/시부야_카논.webp" class="w-4/5 object-contain" onerror="this.style.display='none'">
                        ...
                        <a href="탕 쿠쿠.html" class="w-[28%] sm:w-[18%] flex flex-col items-center wiki-link hover:no-underline">
                            <img src="이미지/탕_쿠쿠.webp" class="w-4/5 object-contain" onerror="this.style.display='none'">
                        ...
                        <a href="아라시 치사토.html" class="w-[28%] sm:w-[18%] flex flex-col items-center wiki-link hover:no-underline">
                            <img src="이미지/아라시_치사토.webp" class="w-4/5 object-contain" onerror="this.style.display='none'">
                        ...
                        <a href="헤안나 스미레.html" class="w-[28%] sm:w-[18%] flex flex-col items-center wiki-link hover:no-underline">
                            <img src="이미지/헤안나_스미레.webp" class="w-4/5 object-contain" onerror="this.style.display='none'">
                        ...
                        <a href="하즈키 렌.html" class="w-[28%] sm:w-[18%] flex flex-col items-center wiki-link hover:no-underline">
                            <img src="이미지/하즈키_렌.webp" class="w-4/5 object-contain" onerror="this.style.display='none'">
                ...
                <div class="mb-4">
                    ...
                    <div class="flex justify-evenly flex-wrap gap-2 text-[11px] font-bold">
                        <a href="사쿠라코지 키나코.html" class="w-[28%] sm:w-[22%] flex flex-col items-center wiki-link hover:no-underline">
                            <img src="이미지/사쿠라코지_키나코.webp" class="w-4/5 object-contain" onerror="this.style.display='none'">
                        ...
                        <a href="요네메 메이.html" class="w-[28%] sm:w-[22%] flex flex-col items-center wiki-link hover:no-underline">
                            <img src="이미지/요네메_메이.webp" class="w-4/5 object-contain" onerror="this.style.display='none'">
                        ...
                        <a href="와카나 시키.html" class="w-[28%] sm:w-[22%] flex flex-col items-center wiki-link hover:no-underline">
                            <img src="이미지/와카나_시키.webp" class="w-4/5 object-contain" onerror="this.style.display='none'">
                        ...
                        <a href="오니츠카 나츠미.html" class="w-[28%] sm:w-[22%] flex flex-col items-center wiki-link hover:no-underline">
                            <img src="이미지/오니츠카_나츠미.webp" class="w-4/5 object-contain" onerror="this.style.display='none'">
                ...
                <div>
                    ...
                    <div class="flex justify-evenly flex-wrap gap-2 text-[11px] font-bold">
                        <a href="빈 마르가레테.html" class="w-[35%] sm:w-[25%] flex flex-col items-center wiki-link hover:no-underline">
                            <img src="이미지/빈_마르가레테.webp" class="w-4/5 object-contain" onerror="this.style.display='none'">
                        ...
                        <a href="오니츠카 토마리.html" class="w-[35%] sm:w-[25%] flex flex-col items-center wiki-link hover:no-underline">
                            <img src="이미지/오니츠카_토마리.webp" class="w-4/5 object-contain" onerror="this.style.display='none'">
        ...
        <div class="nw-frame shadow-sm">
            ...
            <details class="mb-1">
                ...
                <!-- Liella! -->
                <details class="nw-box" style="border-color:#DA57D8;" open>
