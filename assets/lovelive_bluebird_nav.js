document.addEventListener("DOMContentLoaded", () => {
    // HTML 문서 내에 <div id="lovelive-bluebird-nav-container"></div> 가 있어야 작동합니다.
    const container = document.getElementById("lovelive-bluebird-nav-container");
    if (!container) return;
    ...
    // 2. 방대한 HTML 구조 주입 (이키즈라이부 멤버 박스 + 전체 시리즈 틀)
    const navHtml = `
        <!-- [이키즈라이부! 멤버 목록 표 박스] -->
        <div class="w-full max-w-[600px] mx-auto border-[1.5px] border-[#80c5e1] rounded-[10px] bg-[#80c5e1] text-center overflow-hidden mb-6 shadow-sm">
            <div class="w-4/5 mx-auto py-3 border-b border-white font-bold text-xl text-black">
                <a href="이키즈라이브! LOVELIVE! BLUEBIRD.html" class="nw-link"><img src="이미지/이키즈라이부로고.webp" alt="이키즈라이브! LOVELIVE! BLUEBIRD" class="w-3/4 mx-auto" onerror="this.style.display='none'; this.nextSibling.style.display='inline';"><span style="display:none; color:#375561;">이키즈라이부!</span></a>
            </div>
            ...
            <details class="bg-white dark:bg-[#2d2f34] text-black dark:text-white p-3" open>
                ...
                <div class="flex justify-evenly flex-wrap gap-2 text-[11px] font-bold">
                    ...
                    <a href="타카하시 폴카.html" class="w-[22%] sm:w-[18%] flex flex-col items-center wiki-link hover:no-underline mb-2">
                        <img src="이미지/타카하시 폴카.webp" class="w-4/5 object-contain" onerror="this.style.display='none'">
                        <span class="mt-1 px-1 py-[2px] rounded text-white bg-[#ff8899] w-full text-center">폴카</span>
                    </a>
                    <a href="카나자와 미라클.html" class="w-[22%] sm:w-[18%] flex flex-col items-center wiki-link hover:no-underline mb-2">
                        <img src="이미지/카나자와_미라클.webp" class="w-4/5 object-contain" onerror="this.style.display='none'">
                        <span class="mt-1 px-1 py-[2px] rounded text-black bg-[#ffcc11] w-full text-center">미라클</span>
                    </a>
                    <a href="하루미야 유쿠리.html" class="w-[22%] sm:w-[18%] flex flex-col items-center wiki-link hover:no-underline mb-2">
                        <img src="이미지/하루미야_유쿠리.webp" class="w-4/5 object-contain" onerror="this.style.display='none'">
                        <span class="mt-1 px-1 py-[2px] rounded text-white bg-[#00ccaa] w-full text-center">유쿠리</span>
                    </a>
                    <a href="사사키 시온.html" class="w-[22%] sm:w-[18%] flex flex-col items-center wiki-link hover:no-underline mb-2">
                        <img src="이미지/사사키_시온.webp" class="w-4/5 object-contain" onerror="this.style.display='none'">
                        <span class="mt-1 px-1 py-[2px] rounded text-white bg-[#881188] w-full text-center">시온</span>
                    </a>
                    <a href="아자부 마이.html" class="w-[22%] sm:w-[18%] flex flex-col items-center wiki-link hover:no-underline mb-2">
                        <img src="이미지/아자부_마이.webp" class="w-4/5 object-contain" onerror="this.style.display='none'">
                        <span class="mt-1 px-1 py-[2px] rounded text-white bg-[#0077dd] w-full text-center">마이</span>
                    </a>
                    
                    <a href="코노하나 오로라.html" class="w-[22%] sm:w-[18%] flex flex-col items-center wiki-link hover:no-underline mb-2">
                        <img src="이미지/코노하나_오로라.webp" class="w-4/5 object-contain" onerror="this.style.display='none'">
                        <span class="mt-1 px-1 py-[2px] rounded text-white bg-[#9856ff] w-full text-center">오로라</span>
                    </a>
                    <a href="고토 아키라.html" class="w-[22%] sm:w-[18%] flex flex-col items-center wiki-link hover:no-underline mb-2">
                        <img src="이미지/고토 아키라.webp" class="w-4/5 object-contain" onerror="this.style.display='none'">
                        <span class="mt-1 px-1 py-[2px] rounded text-black bg-[#bdedad] w-full text-center">아키라</span>
                    </a>
                    <a href="쵸후 노리코.html" class="w-[22%] sm:w-[18%] flex flex-col items-center wiki-link hover:no-underline mb-2">
                        <img src="이미지/쵸후 노리코.webp" class="w-4/5 object-contain" onerror="this.style.display='none'">
                        <span class="mt-1 px-1 py-[2px] rounded text-white bg-[#ee0022] w-full text-center">노리코</span>
                    </a>
                    <a href="야마다 미도리.html" class="w-[22%] sm:w-[18%] flex flex-col items-center wiki-link hover:no-underline mb-2">
                        <img src="이미지/야마다_미도리.webp" class="w-4/5 object-contain" onerror="this.style.display='none'">
                        <span class="mt-1 px-1 py-[2px] rounded text-white bg-[#37b484] w-full text-center">미도리</span>
                    </a>
                    <a href="코마가타 하나비.html" class="w-[22%] sm:w-[18%] flex flex-col items-center wiki-link hover:no-underline mb-2">
                        <img src="이미지/코마가타_하나비.webp" class="w-4/5 object-contain" onerror="this.style.display='none'">
                        <span class="mt-1 px-1 py-[2px] rounded text-white bg-[#ff5522] w-full text-center">하나비</span>
                    </a>
                </div>
            </details>
        </div>
