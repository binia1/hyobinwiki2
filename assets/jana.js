...
"홈플러스 창전점": "홈플러스 창전점.html","빈주 2호선": "빈주 2호선.html","빈주 1호선": "빈주 1호선.html",      "오시연": "오시연.html",
    "고상철": "고상철.html",
    "남소현": "남소현.html",
    "위서은": "위서은.html",
...
populateRecentList();
            ...
            const populateAds = () => {
                ...
                const ads = [
                    { title: "효빈지하철 2호선 하루빈과 함께!", img: "이미지/하루빈_광고.png", link: "효빈도시철도.html" },
                    { title: "제4회 효빈 애니메이션 페스티벌", img: "이미지/haf_banner.png", link: "효빈축제.html" },
                    { title: "박효빈 시장의 발전 계획", img: "이미지/mayor_ad.png", link: "박효빈.html" }
                ];
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const ads = [
        ...
        { title: "제17회 효빈 애니메이션 페스티벌", img: "이미지/HAF광고.png", link: "HAF.html" },
        ...
        { title: "【신규 역장 특전】 지금 접속 시 무료 300연차 & 사능동 소금빵 500개 지급! 리세마라 0티어 [UR 골든 아워 박라미] 확정 획득 찬스!", img: "이미지/레일루미네_스마일_페스티벌.png", link: "레일루미네_스마일 페스티벌.html" },
        { title: "🚨국회의원도 기겁한 논란의 그 게임! '효빈 집 침실' 배경 풀더빙 상호작용 업데이트! 당장 플레이하세요", img: "이미지/효빈집침실.png", link: "레일루미네_스마일 페스티벌.html" },
        { title: "\"선배님 이름 조별과제에서 뺍니다? 찡긋~💕\" 어뮤즈의 광견 [SSR 전노아] 한정 픽업 진행 중! (지금 다운로드)", img: "이미지/전노아 과잠2.png", link: "레일루미네_스마일_페스티벌_게임.html" },
        { title: "Lv.1 짬처리 역무원 박빛나 ➡️ Lv.99 단말기 퀵드로우 마스터! 당신만의 철도 미소녀를 육성하세요!", img: "이미지/박빛나.png", link: "레일루미네_스마일_페스티벌_게임.html" },{ 
