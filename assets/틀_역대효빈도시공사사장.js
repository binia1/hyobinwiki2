...
<div style="border: 1px solid #ccc; font-family: 'Noto Sans KR', sans-serif; background-color: #fff; max-width: 100%; box-sizing: border-box; clear: both; margin-bottom: 40px;">
    <div style="background-color: #7777AA; padding: 25px 0 15px 0; text-align: center; border-bottom: 1px solid #555588;">
        <img src="이미지/효빈도시공사_로고.webp" alt="효빈도시공사" onerror="this.outerHTML='<span style=\\'font-size:1.5rem; font-weight:bold; color:white;\\'>효빈도시공사</span>'" style="height: 50px; display: block; margin: 0 auto 10px auto; object-fit: contain;">
        <div style="color: #fff; font-size: 1.2rem; font-weight: bold; letter-spacing: -0.5px;">역대 효빈도시공사 사장</div>
    </div>
        ...
        <div style="padding: 0;">
            <table style="width: 100%; border-collapse: collapse; text-align: center; font-size: 0.95rem; margin: 0; background-color: #fff; table-layout: fixed;">
                ...
                <tr>
                    ...
                    <th style="background-color: #008CCD; color: #fff; padding: 8px; font-weight: bold; border: 1px solid #ddd;">김성민 시정</th>
                </tr>
                <tr style="line-height: 1.8;">
                    ...
                    <td style="padding: 15px 5px; border: 1px solid #ddd; vertical-align: top;">
                        ...
                        <a href="신응진.html" style="color: #0055AA; font-weight: bold; text-decoration: none;">신응진</a>
                    </td>
                </tr>
                <tr>
                ...
                <tr style="line-height: 1.8;">
                    <td style="padding: 15px 5px; border: 1px solid #ddd; vertical-align: top;">
                        ...
                        <a href="여상훈.html" style="color: #0055AA; font-weight: bold; text-decoration: none;">여상훈</a>
                    </td>
                    <td style="padding: 15px 5px; border: 1px solid #ddd; vertical-align: top; background-color: #f0f8ff;">
                        ...
                        <strong style="color: #005BAC; font-size: 1.05rem;">김도빈</strong>
                    </td>
