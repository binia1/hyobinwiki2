document.addEventListener("DOMContentLoaded", () => {
    const container = document.getElementById("lovelive-hasu-nav-container");
    if (!container) return;
    ...
    // 2. 방대한 HTML 구조 주입 (하스노소라 멤버 박스 + 전체 시리즈 틀)
    const navHtml = `
        <!-- [하스노소라 멤버 목록 표 박스] -->
        <div class="w-full max-w-[600px] mx-auto border-[1.5px] border-[#f7b6c0] rounded-[10px] bg-[#f7b6c0] text-center overflow-hidden mb-6 shadow-sm">
            <div class="w-4/5 mx-auto py-3 border-b border-white font-bold text-xl text-black">
                <a href="하스노소라 여학원 스쿨 아이돌 클럽.html" class="nw-link"><img src="이미지/하스노소라여학원스쿨아이돌클럽로고.webp" alt="하스노소라 여학원 스쿨 아이돌 클럽" class="w-3/4 mx-auto" onerror="this.style.display='none'; this.nextSibling.style.display='inline';"><span style="display:none; color:#be1400;">하스노소라 여학원 스쿨 아이돌 클럽</span></a>
            </div>
            
            <!-- 현역 멤버 (펼치기/접기) -->
            <details class="bg-white dark:bg-[#2d2f34] text-black dark:text-white p-3" open>
                ...
                <div class="flex justify-evenly flex-wrap gap-2 text-[11px] font-bold">
                    ...
                    <a href="모모세 긴코.html" class="w-[22%] sm:w-[18%] flex flex-col items-center wiki-link hover:no-underline mb-2">
                        <img src="이미지/모모세_긴코.webp" class="w-4/5 object-contain" onerror="this.style.display='none'">
                        <span class="mt-1 px-1 py-[2px] rounded text-black bg-[#a2d7dd] w-full text-center">긴코</span>
                    </a>
                    <a href="카치마치 코스즈.html" class="w-[22%] sm:w-[18%] flex flex-col items-center wiki-link hover:no-underline mb-2">
                        <img src="이미지/카치마치_코스즈.webp" class="w-4/5 object-contain" onerror="this.style.display='none'">
                        <span class="mt-1 px-1 py-[2px] rounded text-black bg-[#fad764] w-full text-center">코스즈</span>
                    </a>
                    <a href="안요지 히메.html" class="w-[22%] sm:w-[18%] flex flex-col items-center wiki-link hover:no-underline mb-2">
                        <img src="이미지/안요지 히메.webp" class="w-4/5 object-contain" onerror="this.style.display='none'">
                        <span class="mt-1 px-1 py-[2px] rounded text-white bg-[#9d8de2] w-full text-center">히메</span>
                    </a>
                    <a href="세라스 야나기다 릴리엔펠트.html" class="w-[22%] sm:w-[18%] flex flex-col items-center wiki-link hover:no-underline mb-2">
                        <img src="이미지/세라스_야나기다_릴리엔펠트.webp" class="w-4/5 object-contain" onerror="this.style.display='none'">
                        <span class="mt-1 px-1 py-[2px] rounded text-white bg-[#f56455] w-full text-center">세라스</span>
                    </a>
                    <a href="카츠라기 이즈미.html" class="w-[22%] sm:w-[18%] flex flex-col items-center wiki-link hover:no-underline mb-2">
                        <img src="이미지/카츠라기_이즈미.webp" class="w-4/5 object-contain" onerror="this.style.display='none'">
                        <span class="mt-1 px-1 py-[2px] rounded text-white bg-[#1ebecd] w-full text-center">이즈미</span>
                    </a>
                                        <a href="킨죠 마이카.html" class="w-[22%] sm:w-[18%] flex flex-col items-center wiki-link hover:no-underline mb-2">
                        <img src="이미지/킨죠_마이카.webp" class="w-4/5 object-contain" onerror="this.style.display='none'">
                        <span class="mt-1 px-1 py-[2px] rounded text-white bg-[#9d8de2] w-full text-center">마이카</span>
                    </a>
                    <a href="레이사와 아오이.html" class="w-[22%] sm:w-[18%] flex flex-col items-center wiki-link hover:no-underline mb-2">
                        <img src="이미지/레이사와_아오이.webp" class="w-4/5 object-contain" onerror="this.style.display='none'">
                        <span class="mt-1 px-1 py-[2px] rounded text-white bg-[#f56455] w-full text-center">아오이</span>
                    </a>
                    <a href="시노와 미온.html" class="w-[22%] sm:w-[18%] flex flex-col items-center wiki-link hover:no-underline mb-2">
                        <img src="이미지/시노와_미온.webp" class="w-4/5 object-contain" onerror="this.style.display='none'">
                        <span class="mt-1 px-1 py-[2px] rounded text-white bg-[#1ebecd] w-full text-center">미온</span>
                    </a>
                </div>
            </details>

            <!-- 졸업 멤버 (102기) -->
            <details class="bg-white dark:bg-[#2d2f34] text-black dark:text-white p-3 border-t border-gray-200 dark:border-gray-700">
                <summary class="cursor-pointer text-xs text-gray-500 mb-2 list-none outline-none text-center">[ 졸업 멤버 ]</summary>
                
                <div class="mb-3">
                    <a href="하스노소라 여학원 102기.html" class="inline-block px-3 py-1 bg-[#4bc0ba] text-white text-[12px] font-bold rounded wiki-link hover:no-underline">102기</a>
                </div>
                
                <div class="flex justify-evenly flex-wrap gap-2 text-[11px] font-bold">
                    <a href="오토무네 코즈에.html" class="w-[28%] sm:w-[18%] flex flex-col items-center wiki-link hover:no-underline">
                        <img src="이미지/오토무네_코즈에.webp" class="w-4/5 object-contain" onerror="this.style.display='none'">
                        <span class="mt-1 px-1 py-[2px] rounded text-white bg-[#68be8d] w-full text-center">코즈에</span>
                    </a>
                    <a href="유기리 츠즈리.html" class="w-[28%] sm:w-[18%] flex flex-col items-center wiki-link hover:no-underline">
                        <img src="이미지/유기리_츠즈리.webp" class="w-4/5 object-contain" onerror="this.style.display='none'">
                        <span class="mt-1 px-1 py-[2px] rounded text-white bg-[#ba2636] w-full text-center">츠즈리</span>
                    </a>
                    <a href="후지시마 메구미.html" class="w-[28%] sm:w-[18%] flex flex-col items-center wiki-link hover:no-underline">
                        <img src="이미지/후지시마_메구미.webp" class="w-4/5 object-contain" onerror="this.style.display='none'">
                        <span class="mt-1 px-1 py-[2px] rounded text-white bg-[#c8c2c6] w-full text-center">메구미</span>
                    </a>
                </div>
                
                <div class="mb-3">
                    <a href="하스노소라 여학원 103기.html" class="inline-block px-3 py-1 bg-[#4bc0ba] text-white text-[12px] font-bold rounded wiki-link hover:no-underline">103기</a>
                </div>
                
                <div class="flex justify-evenly flex-wrap gap-2 text-[11px] font-bold">
                    <a href="히노시타 카호.html" class="w-[22%] sm:w-[18%] flex flex-col items-center wiki-link hover:no-underline mb-2">
                        <img src="이미지/히노시타_카호.webp" class="w-4/5 object-contain" onerror="this.style.display='none'">
                        <span class="mt-1 px-1 py-[2px] rounded text-white bg-[#f8b500] w-full text-center">카호</span>
                    </a>
                    <a href="무라노 사야카.html" class="w-[22%] sm:w-[18%] flex flex-col items-center wiki-link hover:no-underline mb-2">
                        <img src="이미지/무라노 사야카.webp" class="w-4/5 object-contain" onerror="this.style.display='none'">
                        <span class="mt-1 px-1 py-[2px] rounded text-white bg-[#5383c3] w-full text-center">사야카</span>
                    </a>
                    <a href="오사와 루리노.html" class="w-[22%] sm:w-[18%] flex flex-col items-center wiki-link hover:no-underline mb-2">
                        <img src="이미지/오사와_루리노.webp" class="w-4/5 object-contain" onerror="this.style.display='none'">
                        <span class="mt-1 px-1 py-[2px] rounded text-white bg-[#e7609e] w-full text-center">루리노</span>
                    </a>
                </div>
            </details>
        </div>
            ...
            <details class="mb-1">
                ...
                <details class="nw-box" style="border-color:#ed6d00;">
                    ...
                    <table class="nw-tbl" style="border-color:#ed6d00;">
                        ...
                        <tr>
                            <td><a href="고토 아키라.html" class="nw-link"><img src="이미지/고토 아키라.webp" class="nw-img" onerror="this.style.display='none'">고토 아키라</a></td>
