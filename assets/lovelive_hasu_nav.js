    ...
    const navHtml = `
        ...
        <div class="w-full max-w-[600px] mx-auto border-[1.5px] border-[#f7b6c0] rounded-[10px] bg-[#f7b6c0] text-center overflow-hidden mb-6 shadow-sm">
            <div class="w-4/5 mx-auto py-3 border-b border-white font-bold text-xl text-black">
                <a href="하스노소라 여학원 스쿨 아이돌 클럽.html" class="nw-link"><img src="이미지/하스노소라여학원스쿨아이돌클럽로고.png" alt="하스노소라 여학원 스쿨 아이돌 클럽" class="w-3/4 mx-auto" onerror="this.style.display='none'; this.nextSibling.style.display='inline';"><span style="display:none; color:#be1400;">하스노소라 여학원 스쿨 아이돌 클럽</span></a>
            </div>
            ...
            <details class="bg-white dark:bg-[#2d2f34] text-black dark:text-white p-3" open>
                ...
                <div class="flex justify-evenly flex-wrap gap-2 text-[11px] font-bold">
                    ...
                    <a href="모모세 긴코.html" class="w-[22%] sm:w-[18%] flex flex-col items-center wiki-link hover:no-underline mb-2">
                        <img src="이미지/모모세 긴코.png" class="w-4/5 object-contain" onerror="this.style.display='none'">
                    ...
                    <a href="카치마치 코스즈.html" class="w-[22%] sm:w-[18%] flex flex-col items-center wiki-link hover:no-underline mb-2">
                        <img src="이미지/카치마치 코스즈.png" class="w-4/5 object-contain" onerror="this.style.display='none'">
                    ...
                    <a href="안요지 히메.html" class="w-[22%] sm:w-[18%] flex flex-col items-center wiki-link hover:no-underline mb-2">
                        <img src="이미지/안요지 히메.png" class="w-4/5 object-contain" onerror="this.style.display='none'">
                    ...
                    <a href="세라스 야나기다 릴리엔펠트.html" class="w-[22%] sm:w-[18%] flex flex-col items-center wiki-link hover:no-underline mb-2">
                        <img src="이미지/세라스 야나기다 릴리엔펠트.png" class="w-4/5 object-contain" onerror="this.style.display='none'">
                    ...
                    <a href="카츠라기 이즈미.html" class="w-[22%] sm:w-[18%] flex flex-col items-center wiki-link hover:no-underline mb-2">
                        <img src="이미지/카츠라기 이즈미.png" class="w-4/5 object-contain" onerror="this.style.display='none'">
                        ...
                        <img src="이미지/킨죠 마이카.png" class="w-4/5 object-contain" onerror="this.style.display='none'">
                    ...
                    <a href="레이사와 아오이.html" class="w-[22%] sm:w-[18%] flex flex-col items-center wiki-link hover:no-underline mb-2">
                        <img src="이미지/레이사와 아오이.png" class="w-4/5 object-contain" onerror="this.style.display='none'">
                    ...
                    <a href="시노와 미온.html" class="w-[22%] sm:w-[18%] flex flex-col items-center wiki-link hover:no-underline mb-2">
                        <img src="이미지/시노와 미온.png" class="w-4/5 object-contain" onerror="this.style.display='none'">
            ...
            <details class="bg-white dark:bg-[#2d2f34] text-black dark:text-white p-3 border-t border-gray-200 dark:border-gray-700">
                ...
                <div class="flex justify-evenly flex-wrap gap-2 text-[11px] font-bold">
                    <a href="오토무네 코즈에.html" class="w-[28%] sm:w-[18%] flex flex-col items-center wiki-link hover:no-underline">
                        <img src="이미지/오토무네 코즈에.png" class="w-4/5 object-contain" onerror="this.style.display='none'">
                    ...
                    <a href="유기리 츠즈리.html" class="w-[28%] sm:w-[18%] flex flex-col items-center wiki-link hover:no-underline">
                        <img src="이미지/유기리 츠즈리.png" class="w-4/5 object-contain" onerror="this.style.display='none'">
                    ...
                    <a href="후지시마 메구미.html" class="w-[28%] sm:w-[18%] flex flex-col items-center wiki-link hover:no-underline">
                        <img src="이미지/후지시마 메구미.png" class="w-4/5 object-contain" onerror="this.style.display='none'">
                ...
                <div class="flex justify-evenly flex-wrap gap-2 text-[11px] font-bold">
                    <a href="히노시타 카호.html" class="w-[22%] sm:w-[18%] flex flex-col items-center wiki-link hover:no-underline mb-2">
                        <img src="이미지/히노시타 카호.png" class="w-4/5 object-contain" onerror="this.style.display='none'">
                    ...
                    <a href="무라노 사야카.html" class="w-[22%] sm:w-[18%] flex flex-col items-center wiki-link hover:no-underline mb-2">
                        <img src="이미지/무라노 사야카.png" class="w-4/5 object-contain" onerror="this.style.display='none'">
                    ...
                    <a href="오사와 루리노.html" class="w-[22%] sm:w-[18%] flex flex-col items-center wiki-link hover:no-underline mb-2">
                        <img src="이미지/오사와 루리노.png" class="w-4/5 object-contain" onerror="this.style.display='none'">
            ...
            <details class="mb-1">
                ...
                <details class="nw-box" style="border-color:#F8B656;">
                    <summary style="background-color:#F8B656;" class="outline-none">
                        <a href="러브 라이브! 니지가사키 학원 스쿨 아이돌 동호회.html" class="nw-link"><img src="이미지/bnr_nijigasaki.png" class="max-w-[450px] w-full object-contain" onerror="this.style.display='none'; this.nextSibling.style.display='inline';"><span style="display:none;">러브 라이브! 니지가사키 학원 스쿨 아이돌 동호회</span></a>
                    </summary>
                    <table class="nw-tbl" style="border-color:#F8B656;">
                        ...
                        <tr>
                            ...
                            <td rowspan="2"><a href="아사카 카린.html" class="nw-link"><img src="이미지/아사카 카린.png" class="nw-img" onerror="this.style.display='none'">아사카 카린</a></td>
                            <td><a href="우에하라 아유무.html" class="nw-link"><img src="이미지/우에하라 아유무.png" class="nw-img" onerror="this.style.display='none'">우에하라 아유무</a></td>
                            <td><a href="나카스 카스미.html" class="nw-link"><img src="이미지/나카스 카스미.png" class="nw-img" onerror="this.style.display='none'">나카스 카스미</a></td>
                            <td><a href="미후네 시오리코.html" class="nw-link"><img src="이미지/미후네 시오리코.png" class="nw-img" onerror="this.style.display='none'">미후네 시오리코</a></td>
                            <td rowspan="4"><a href="타카사키 유우.html" class="nw-link"><img src="이미지/타카사키 유우.png" class="nw-img" onerror="this.style.display='none'">타카사키 유우</a></td>
                        </tr>
                        <tr>
                            <td rowspan="2"><a href="오사카 시즈쿠.html" class="nw-link"><img src="이미지/오사카 시즈쿠.png" class="nw-img" onerror="this.style.display='none'">오사카 시즈쿠</a></td>
                            <td><a href="코노에 카나타.html" class="nw-link"><img src="이미지/코노에 카나타.png" class="nw-img" onerror="this.style.display='none'">코노에 카나타</a></td>
                            <td rowspan="2"><a href="미아 테일러.html" class="nw-link"><img src="이미지/미아 테일러.png" class="nw-img" onerror="this.style.display='none'">미아 테일러</a></td>
                        </tr>
                        <tr>
                            <td rowspan="2"><a href="미야시타 아이.html" class="nw-link"><img src="이미지/미야시타 아이.png" class="nw-img" onerror="this.style.display='none'">미야시타 아이</a></td>
                            <td><a href="엠마 베르데.html" class="nw-link"><img src="이미지/엠마 베르데.png" class="nw-img" onerror="this.style.display='none'">엠마 베르데</a></td>
                        </tr>
                        <tr>
                            <td><a href="유키 세츠나.html" class="nw-link"><img src="이미지/유키 세츠나.png" class="nw-img" onerror="this.style.display='none'">유키 세츠나</a></td>
                            <td><a href="텐노지 리나.html" class="nw-link"><img src="이미지/텐노지 리나.png" class="nw-img" onerror="this.style.display='none'">텐노지 리나</a></td>
                            <td><a href="쇼우 란쥬.html" class="nw-link"><img src="이미지/쇼우 란쥬.png" class="nw-img" onerror="this.style.display='none'">쇼우 란쥬</a></td>
                        </tr>
                        <tr>
                ...
                <details class="nw-box" style="border-color:#ed6d00;">
                    ...
                    <table class="nw-tbl" style="border-color:#ed6d00;">
                        ...
                        <tr>
                            <td><a href="고토 아키라.html" class="nw-link"><img src="이미지/고토 아키라.png" class="nw-img" onerror="this.style.display='none'">고토 아키라</a></td>
