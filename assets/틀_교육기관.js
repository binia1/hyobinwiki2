    ...
    const templateHTML = `
        <div class="wiki-frame-education">
            <div class="wiki-frame-education-title">
                이 문서는 <a href="교육기관.html">교육기관</a> 관련 문서입니다.<br>
                다음과 같은 서술은 작성 시 <a href="편집권 남용.html">편집권 남용</a>으로 간주되어 제재될 수 있습니다.
            </div>
            ...
            <div class="wiki-frame-education-content" id="education-content-area">
                <ul class="wiki-frame-education-list">
                    <li><a href="편집합의.html">편집합의</a>상 허용되는 경우를 제외한, 템플릿:학교에 존재하지 않는 문단의 추가
                        <ul style="padding-left: 20px; list-style-type: circle; margin-top: 4px;">
                            <li>편집합의상 허용되는 경우
                                <ul style="padding-left: 20px; list-style-type: square; margin-top: 4px;">
                                    ...
                                    <li><a href="제도권 언론.html">제도권 언론</a>에 보도된 내용에 대해 하위 문단을 만들어 서술하는 것</li>
                                </ul>
                            </li>
                        </ul>
                    </li>
                    <li>관련 <a href="편집지침.html">편집지침</a>과 편집합의에 어긋나는 서술
                        <ul style="padding-left: 20px; list-style-type: circle; margin-top: 4px;">
                            <li>자주 발생하는 사례
                                <ul style="padding-left: 20px; list-style-type: square; margin-top: 4px;">
                                    <li>학교 밖에서 알려지지 않은 교사나 학생, 혹은 <a href="인물 등재 기준.html">인물 등재 기준</a>을 만족하지 않는 인물에 관한 서술</li>
