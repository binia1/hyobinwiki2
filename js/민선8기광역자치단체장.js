document.addEventListener("DOMContentLoaded", function() {
    ...
    <div style="border: 1px solid #ccc; border-radius: 2px; margin-bottom: 20px; box-shadow: 0 1px 2px rgba(0,0,0,0.1); background-color: #fff; overflow: hidden;">
        ...
        <div style="position: relative; padding: 18px 15px; text-align: center; border-bottom: 1px solid #ccc; background-color: #fff; overflow: hidden; display: flex; align-items: center; justify-content: center; min-height: 50px;">
            ...
            <div style="position: relative; z-index: 10; display: flex; align-items: center; background: white; padding: 0 20px; box-shadow: 0 0 15px 15px white;">
                <img alt="대한민국 국장" onerror="this.src='https://upload.wikimedia.org/wikipedia/commons/thumb/1/11/Emblem_of_South_Korea.svg/100px-Emblem_of_South_Korea.svg'" src="이미지/svg/대한민국_국장.svg" style="width: 45px; vertical-align: middle; margin-right: 15px;"/>
                ...
                <table style="width: 100%; border-collapse: collapse; text-align: center; font-size: 0.9em; table-layout: fixed; margin: 0;">
                    <tbody>
                        ...
                        <tr style="color: white; font-weight: bold;">
                            ...
                            <td style="background-color: #000000; padding: 6px; border: 1px solid #ddd;">대구</td>
                            <td style="background-color: #E61E2B; padding: 6px; border: 1px solid #ddd;">인천</td>
                        </tr>
                        <tr style="background-color: #fff;">
                            <td style="padding: 10px 5px; border: 1px solid #ddd;"><a href="오세훈.html" style="color: #E61E2B; text-decoration: none;">오세훈</a></td>
                            <td style="padding: 10px 5px; border: 1px solid #ddd;"><a href="박형준.html" style="color: #E61E2B; text-decoration: none;">박형준</a></td>
                            <td style="padding: 10px 5px; border: 1px solid #ddd; line-height: 1.3;">
                                <a href="김정기.html" style="color: #000000; text-decoration: none; font-weight: bold;">김정기</a><br>
                        ...
                        <tr style="color: white; font-weight: bold;">
                            ...
                            <td style="background-color: #E61E2B; padding: 6px; border: 1px solid #ddd;">대전</td>
                            <td style="background-color: #E61E2B; padding: 6px; border: 1px solid #ddd;">울산</td>
                            <td style="background-color: #E61E2B; padding: 6px; border: 1px solid #ddd;">세종</td>
                        </tr>
                        <tr style="background-color: #fff;">
                            <td style="padding: 10px 5px; border: 1px solid #ddd;"><a href="강기정.html" style="color: #004EA2; text-decoration: none;">강기정</a></td>
                            <td style="padding: 10px 5px; border: 1px solid #ddd;"><a href="이장우.html" style="color: #E61E2B; text-decoration: none;">이장우</a></td>
                            <td style="padding: 10px 5px; border: 1px solid #ddd;"><a href="김두겸.html" style="color: #E61E2B; text-decoration: none;">김두겸</a></td>
                            <td style="padding: 10px 5px; border: 1px solid #ddd;"><a href="최민호.html" style="color: #E61E2B; text-decoration: none;">최민호</a></td>
                        </tr>

                        <!-- 3열 -->
                        <tr style="color: white; font-weight: bold;">
                            <td style="background-color: #004EA2; padding: 6px; border: 1px solid #ddd;">경기</td>
                            <td style="background-color: #E61E2B; padding: 6px; border: 1px solid #ddd;">강원</td>
                            <td style="background-color: #E61E2B; padding: 6px; border: 1px solid #ddd;">충북</td>
                            <td style="background-color: #E61E2B; padding: 6px; border: 1px solid #ddd;">충남</td>
                        </tr>
                        <tr style="background-color: #fff;">
                            <td style="padding: 10px 5px; border: 1px solid #ddd;"><a href="김동연.html" style="color: #004EA2; text-decoration: none;">김동연</a></td>
                            <td style="padding: 10px 5px; border: 1px solid #ddd;"><a href="김진태.html" style="color: #E61E2B; text-decoration: none;">김진태</a></td>
                            <td style="padding: 10px 5px; border: 1px solid #ddd;"><a href="김영환.html" style="color: #E61E2B; text-decoration: none;">김영환</a></td>
                            <td style="padding: 10px 5px; border: 1px solid #ddd;"><a href="김태흠.html" style="color: #E61E2B; text-decoration: none;">김태흠</a></td>
                        </tr>

                        <!-- 4열 -->
                        <tr style="color: white; font-weight: bold;">
                            <td style="background-color: #777777; padding: 6px; border: 1px solid #ddd;">전북</td>
                            <td style="background-color: #004EA2; padding: 6px; border: 1px solid #ddd;">전남</td>
                        ...
                        <tr style="background-color: #fff;">
                            <td style="padding: 10px 5px; border: 1px solid #ddd;"><a href="김관영.html" style="color: #777777; text-decoration: none;">김관영</a></td>
                            <td style="padding: 10px 5px; border: 1px solid #ddd;"><a href="김영록.html" style="color: #004EA2; text-decoration: none;">김영록</a></td>
                            <td style="padding: 10px 5px; border: 1px solid #ddd;"><a href="이철우.html" style="color: #E61E2B; text-decoration: none;">이철우</a></td>
                            <td style="padding: 10px 5px; border: 1px solid #ddd;"><a href="박완수.html" style="color: #E61E2B; text-decoration: none;">박완수</a></td>
                        </tr>

                        <!-- 5열 (제주 및 추가 요청된 효빈, 덕북, 덕남) -->
                        <tr style="color: white; font-weight: bold;">
                        ...
                        <tr style="background-color: #fff; border-top: 1px solid #ddd;">
                            <td colspan="4" style="padding: 10px; font-size: 0.85em; color: #333; text-align: center;">
                                * 대구광역시장 <a href="홍준표.html" style="color: #E61E2B; text-decoration: none; font-weight: bold;">홍준표</a> 사퇴 (2025.4.11.)
                            </td>
                        </tr>
    ...
    const container = document.querySelector(".minseon8-nav-container");
    if (container) {
        container.innerHTML = minseon8NavHTML;
    }
});