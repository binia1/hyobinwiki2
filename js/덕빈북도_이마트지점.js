...
(function() {
    const container = document.getElementById("emart-deokbinbuk-branches-nav-container");
                        ...
                        <details open style="margin: 0; border: none; background: transparent; border-radius: 0;">
                            ...
                            <div class="details-content" style="padding: 15px;">
                                <table style="width: 100%; border-collapse: collapse; text-align: center; border: none; margin: 0;">
                                    <tr>
                                        <td style="padding: 8px; border: none; width: 25%;">
                                            <a href="이마트_서해점.html" class="wiki-link">서해점</a><br>
                                            <span class="small-text" style="font-size: 0.8em; color: #666;">서해시 좌산동</span>
                                        </td>
                                        <td style="padding: 8px; border: none; width: 25%;">
                                            <a href="이마트_가원점.html" class="wiki-link">가원점</a><br>
                                            <span class="small-text" style="font-size: 0.8em; color: #666;">빈주시 가원구 천조읍</span>
                                        </td>
                                        <td style="padding: 8px; border: none; width: 25%;">
                                            <a href="이마트_빈성점.html" class="wiki-link">빈성점</a><br>
                                            <span class="small-text" style="font-size: 0.8em; color: #666;">빈주시 빈성구 동신동</span>
                                        </td>
                                        <td style="padding: 8px; border: none; width: 25%;">
                                            <a href="이마트_장기점.html" class="wiki-link">장기점</a><br>
                                            <span class="small-text" style="font-size: 0.8em; color: #666;">빈주시 장기구 장기동</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="padding: 8px; border: none;">
                                            <a href="이마트_약산점.html" class="wiki-link">약산점</a><br>
                                            <span class="small-text" style="font-size: 0.8em; color: #666;">약산시 역석동</span>
                                        </td>
                                        <td style="padding: 8px; border: none;">
                                            <a href="이마트_궁하점.html" class="wiki-link">궁하점</a><br>
                                        ...
                                        <td style="padding: 8px; border: none;">
                                            ...
                                            <span class="small-text" style="font-size: 0.8em; color: #666;">강주시 심전동</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="padding: 8px; border: none;">
                                            <a href="이마트_군천점.html" class="wiki-link">군천점</a><br>
                                            <span class="small-text" style="font-size: 0.8em; color: #666;">군천시 애음동</span>
                                        </td>
                                        <td style="padding: 8px; border: none;">
                                            <a href="이마트_계성점.html" class="wiki-link">계성점</a><br>
                                            <span class="small-text" style="font-size: 0.8em; color: #666;">계성시 마시동</span>
                                        </td>
                                        <td style="padding: 8px; border: none;">
                                            <a href="이마트_공항점.html" class="wiki-link">공항점</a><br>
                                            <span class="small-text" style="font-size: 0.8em; color: #666;">기도군 염곡면</span>
                                        </td>
