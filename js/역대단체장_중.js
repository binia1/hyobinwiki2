...
document.addEventListener("DOMContentLoaded", function() {
    var containers = document.querySelectorAll(".hb-history-중-0-nav");
...
<tr>
<td class="history-nav-toggle" colspan="5" onclick="toggleHistoryNav_중_0()">
<span id="history-nav-text-중-0">[ 펼치기 · 접기 ]</span>
</td>
</tr>
</thead>
<tbody id="history-nav-body-중-0">
<tr>
...
if (typeof window.toggleHistoryNav_중_0 === 'undefined') {
    window.toggleHistoryNav_중_0 = function() {
        var body = document.getElementById("history-nav-body-중-0");
        var text = document.getElementById("history-nav-text-중-0");
        if (!body) return;
