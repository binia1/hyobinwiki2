...
document.addEventListener("DOMContentLoaded", function() {
    ...
    var textColor = "white";
    var containers = document.querySelectorAll(".hb-매성시-nav");

    containers.forEach(function(container, index) {
        var uniqueNavId = "매성시Nav_" + index;
        var uniqueLabelId = "매성시Label_" + index;
            ...
            <div class="nav-header-container-auto" onclick="toggleNav('${uniqueNavId}', '${uniqueLabelId}')">
                <div class="nav-header-top-auto">
                    <div class="nav-header-title-box">
                        <img src="이미지/매성시.webp" alt="로고" style="height: 40px;" onerror="this.src='이미지/hyobin1.webp'">
