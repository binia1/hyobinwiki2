...
document.addEventListener("DOMContentLoaded", function() {
    ...
    var textColor = "white";
    var containers = document.querySelectorAll(".hb-덕빈남도분주군-nav");

    containers.forEach(function(container, index) {
        var uniqueNavId = "덕빈남도분주군Nav_" + index;
        var uniqueLabelId = "덕빈남도분주군Label_" + index;
            ...
            <div class="nav-header-container-auto" onclick="toggleNav('${uniqueNavId}', '${uniqueLabelId}')">
                <div class="nav-header-top-auto">
                    <div class="nav-header-title-box">
                        <img onerror="this.src='이미지/hyobin1.webp'" src="이미지/분주군.webp" style="height: 40px; filter: brightness(0) invert(1);"/>
