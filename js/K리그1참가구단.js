    ...
    if (container) {
        ...
        <details class="kl-container" open>
            ...
            <div class="kl-grid">
                <!-- 1. 강원 -->
                <div class="kl-item">
                    <div class="kl-item-logo"><img alt="강원 FC" onerror="this.style.display='none'" src="이미지/svg/강원FC_로고.svg"/></div>
                    <div class="kl-item-name" style="background-color: #FF6600;">강원</div>
                </div>
                <!-- 2. 광주 -->
                <div class="kl-item">
                    <div class="kl-item-logo"><img alt="광주 FC" onerror="this.style.display='none'" src="이미지/svg/광주FC_로고.svg"/></div>
                    <div class="kl-item-name" style="background-color: #FFA500;">광주</div>
                </div>
                <!-- 3. 김천 -->
                <div class="kl-item">
                    <div class="kl-item-logo"><img alt="김천 상무" onerror="this.style.display='none'" src="이미지/svg/김천상무_로고.svg"/></div>
                    <div class="kl-item-name" style="background-color: #D31145;">김천</div>
                </div>
                <!-- 4. 대전 -->
                <div class="kl-item">
                    <div class="kl-item-logo"><img alt="대전 하나 시티즌" onerror="this.style.display='none'" src="이미지/svg/대전하나시티즌_로고.svg"/></div>
                ...
                <!-- 6. 부천 -->
                <div class="kl-item">
                    <div class="kl-item-logo"><img alt="부천 FC 1995" onerror="this.style.display='none'" src="이미지/svg/부천FC_로고.svg"/></div>
                    <div class="kl-item-name" style="background-color: #A6192E;">부천</div>
                </div>
                <!-- 7. 서울 -->
                <div class="kl-item">
                    <div class="kl-item-logo"><img alt="FC 서울" onerror="this.style.display='none'" src="이미지/svg/FC서울_로고.svg"/></div>
                    <div class="kl-item-name" style="background-color: #E31837;">서울</div>
                </div>
                <!-- 8. 안양 -->
                <div class="kl-item">
                    <div class="kl-item-logo"><img alt="FC 안양" onerror="this.style.display='none'" src="이미지/svg/FC안양_로고.svg"/></div>
                    <div class="kl-item-name" style="background-color: #4B2E83;">안양</div>
                </div>
                <!-- 9. 울산 -->
                <div class="kl-item">
                    <div class="kl-item-logo"><img alt="울산 HD" onerror="this.style.display='none'" src="이미지/svg/울산HD_로고.svg"/></div>
                    <div class="kl-item-name" style="background-color: #005BAC;">울산</div>
                </div>
                <!-- 10. 인천 -->
                <div class="kl-item">
                    <div class="kl-item-logo"><img alt="인천 유나이티드" onerror="this.style.display='none'" src="이미지/svg/인천유나이티드_로고.svg"/></div>
                    <div class="kl-item-name" style="background-color: #005BAC;">인천</div>
                </div>
                <!-- 11. 전북 -->
                <div class="kl-item">
                    <div class="kl-item-logo"><img alt="전북 현대 모터스" onerror="this.style.display='none'" src="이미지/svg/전북현대_로고.svg"/></div>
                    <div class="kl-item-name" style="background-color: #007A5E;">전북</div>
                </div>
                <!-- 12. 제주 -->
                <div class="kl-item">
                    <div class="kl-item-logo"><img alt="제주 유나이티드" onerror="this.style.display='none'" src="이미지/svg/제주유나이티드_로고.svg"/></div>
                    <div class="kl-item-name" style="background-color: #FF6600;">제주</div>
                </div>
                <!-- 13. 포항 -->
                <div class="kl-item">
                    <div class="kl-item-logo"><img alt="포항 스틸러스" onerror="this.style.display='none'" src="이미지/svg/포항스틸러스_로고.svg"/></div>
