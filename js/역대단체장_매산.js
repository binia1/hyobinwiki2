...
document.addEventListener("DOMContentLoaded", function() {
    var containers = document.querySelectorAll(".hb-history-매산-0-nav");
...
<tr>
<td class="history-nav-toggle-maesan" colspan="5" onclick="toggleHistoryNav_매산_0()">
<span id="history-nav-text-매산-0">[ 펼치기 · 접기 ]</span>
</td>
</tr>
</thead>
<tbody id="history-nav-body-매산-0">
<tr>
...
if (typeof window.toggleHistoryNav_매산_0 === 'undefined') {
    window.toggleHistoryNav_매산_0 = function() {
        var body = document.getElementById("history-nav-body-매산-0");
        var text = document.getElementById("history-nav-text-매산-0");
        if (!body) return;
