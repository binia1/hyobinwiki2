/**
 * 파일명: js/역대단체장_역대덕빈북도서해.js
 * 설명: 역대 덕빈북도 서해시장 내비게이션 자동 생성
 */
document.addEventListener("DOMContentLoaded", function() {
    var containers = document.querySelectorAll(".hb-history-역대덕빈북도서해-nav");
...
<tr>
<td class="history-nav-toggle" colspan="5" onclick="toggleHistoryNav_역대덕빈북도서해()">
<span id="history-nav-text-역대덕빈북도서해">[ 펼치기 · 접기 ]</span>
</td>
</tr>
</thead>
<tbody id="history-nav-body-역대덕빈북도서해">
<tr>
...
// 개별 토글 함수 자동 생성
if (typeof window.toggleHistoryNav_역대덕빈북도서해 === 'undefined') {
    window.toggleHistoryNav_역대덕빈북도서해 = function() {
        var body = document.getElementById("history-nav-body-역대덕빈북도서해");
        var text = document.getElementById("history-nav-text-역대덕빈북도서해");
        if (!body || !text) return;
