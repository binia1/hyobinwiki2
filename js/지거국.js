        ...
        <div class="nw-box">
            ...
            <details class="nw-details" open="">
                ...
                <table class="nw-grid-table">
                    ...
                    <tr>
                        <td><img src="이미지/강원대.svg" style="height:50px; margin:0 auto 5px;"/><br/><a class="nw-link nw-bold">강원대학교</a></td>
                        <td><img src="이미지/경북대.svg" style="height:50px; margin:0 auto 5px;"/><br/><a class="nw-link nw-bold">경북대학교</a></td>
                        <td><img src="이미지/경상국립대학교_로고.svg" style="height:50px; margin:0 auto 5px;"/><br/><a class="nw-link nw-bold">경상국립대학교</a></td>
                        <td><img src="이미지/부산대.svg" style="height:50px; margin:0 auto 5px;"/><br/><a class="nw-link nw-bold">부산대학교</a></td>
                        <td><img src="이미지/서울대.svg" style="height:50px; margin:0 auto 5px;"/><br/><a class="nw-link nw-bold">서울대학교</a></td>
                    </tr>
                    <tr><th>전남광주</th><th>전북</th><th>제주</th><th>대전·세종</th><th>충북·세종</th></tr>
                    <tr>
                        <td><img src="이미지/전남대.svg" style="height:50px; margin:0 auto 5px;"/><br/><a class="nw-link nw-bold">전남대학교</a></td>
                        <td><img src="이미지/전북대_로고.svg" style="height:50px; margin:0 auto 5px;"/><br/><a class="nw-link nw-bold">전북대학교</a></td>
                        <td><img src="이미지/제주대.svg" style="height:50px; margin:0 auto 5px;"/><br/><a class="nw-link nw-bold">제주대학교</a></td>
                        <td><img src="이미지/충남대.svg" style="height:50px; margin:0 auto 5px;"/><br/><a class="nw-link nw-bold">충남대학교</a></td>
                        <td><img src="이미지/충북대.svg" style="height:50px; margin:0 auto 5px;"/><br/><a class="nw-link nw-bold">충북대학교</a></td>
                    </tr>
