document.addEventListener("DOMContentLoaded", function() {
    function renderDeokbinnamHead2Nav(containerId) {
        ...
        <div class="nav-box shadow-sm" style="border: 1px solid #aaa; margin-bottom: 30px; background-color: #fff; font-family: 'Noto Sans KR', sans-serif;">
            <div class="nav-header tracking-wide" style="background-color: #335566; color: white; text-align: center; font-weight: bold; padding: 8px; font-size: 1.05rem;">
                ...
                <span style="display:inline-flex; align-items:center; gap:6px;">
                    ...
                    <a href="덕빈남도.html" style="color:white; text-decoration: none;">덕빈남도 민선 2기 기초자치단체장</a>
                </span>
            </div>
            <details  style="width: 100%;">
                ...
                <div style="padding: 0;">
                    <table class="nav-table" style="width: 100%; border-collapse: collapse; table-layout: fixed; background-color: #ffffff; text-align: center; font-size: 0.95rem; word-break: keep-all;">
                        <tbody>
                                        <tr>
                                            <td class="district-cell" style="width: 20%; background-color: #00AA7B; padding: 8px 4px; border: 1px solid #aaa; font-weight: bold;"><a href="덕주시.html" style="color: #ffffff; text-decoration: none;">덕주시</a></td>
                                            <td class="district-cell" style="width: 20%; background-color: #00AA7B; padding: 8px 4px; border: 1px solid #aaa; font-weight: bold;"><a href="매성시.html" style="color: #ffffff; text-decoration: none;">매성시</a></td>
                                            <td class="district-cell" style="width: 20%; background-color: #00AA7B; padding: 8px 4px; border: 1px solid #aaa; font-weight: bold;"><a href="원안군.html" style="color: #ffffff; text-decoration: none;">원안군</a></td>
                                            ...
                                            <td class="district-cell" style="width: 20%; background-color: #00AA7B; padding: 8px 4px; border: 1px solid #aaa; font-weight: bold;"><a href="방산시.html" style="color: #ffffff; text-decoration: none;">방산시</a></td>
                                        </tr>
                                        <tr>
                                            <td class="member-cell" style="background-color: #ffffff; padding: 8px 4px; border: 1px solid #aaa; font-weight: bold;"><a href="남기현.html" style="color: #00AA7B; text-decoration: none;">남기현</a></td>
                                            <td class="member-cell" style="background-color: #ffffff; padding: 8px 4px; border: 1px solid #aaa; font-weight: bold;"><a href="문현기.html" style="color: #00AA7B; text-decoration: none;">문현기</a></td>
                                            <td class="member-cell" style="background-color: #ffffff; padding: 8px 4px; border: 1px solid #aaa; font-weight: bold;"><a href="삼헌수.html" style="color: #00AA7B; text-decoration: none;">삼헌수</a></td>
                                            ...
                                            <td class="member-cell" style="background-color: #ffffff; padding: 8px 4px; border: 1px solid #aaa; font-weight: bold;"><a href="원유선.html" style="color: #00AA7B; text-decoration: none;">원유선</a></td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="district-cell" style="width: 20%; background-color: #00AA7B; padding: 8px 4px; border: 1px solid #aaa; font-weight: bold;"><a href="낙주시.html" style="color: #ffffff; text-decoration: none;">낙주시</a></td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="member-cell" style="background-color: #ffffff; padding: 8px 4px; border: 1px solid #aaa; font-weight: bold;"><a href="국성연.html" style="color: #00AA7B; text-decoration: none;">국성연</a></td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="district-cell" style="width: 20%; background-color: #00AA7B; padding: 8px 4px; border: 1px solid #aaa; font-weight: bold;"><a href="매산군.html" style="color: #ffffff; text-decoration: none;">매산군</a></td>
                                            <td class="district-cell" style="width: 20%; background-color: #1B5B40; padding: 8px 4px; border: 1px solid #aaa; font-weight: bold;"><a href="인곡군.html" style="color: #ffffff; text-decoration: none;">인곡군</a></td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="member-cell" style="background-color: #ffffff; padding: 8px 4px; border: 1px solid #aaa; font-weight: bold;"><a href="조응현.html" style="color: #00AA7B; text-decoration: none;">조응현</a></td>
                                            <td class="member-cell" style="background-color: #ffffff; padding: 8px 4px; border: 1px solid #aaa; font-weight: bold;"><a href="인시현.html" style="color: #1B5B40; text-decoration: none;">인시현</a></td>
                                        ...
                                        <tr>
                                            <td class="district-cell" style="width: 20%; background-color: #00AA7B; padding: 8px 4px; border: 1px solid #aaa; font-weight: bold;"><a href="운진군.html" style="color: #ffffff; text-decoration: none;">운진군</a></td>
                                            <td class="district-cell" style="width: 20%; background-color: #1B5B40; padding: 8px 4px; border: 1px solid #aaa; font-weight: bold;"><a href="두원군.html" style="color: #ffffff; text-decoration: none;">두원군</a></td>
                                            <td style="width: 20%; background-color: #f9f9f9; border: 1px solid #aaa; "></td>
                                            <td style="width: 20%; background-color: #f9f9f9; border: 1px solid #aaa; "></td>
                                            <td style="width: 20%; background-color: #f9f9f9; border: 1px solid #aaa; "></td>
                                        </tr>
                                        <tr>
                                            <td class="member-cell" style="background-color: #ffffff; padding: 8px 4px; border: 1px solid #aaa; font-weight: bold;"><a href="조삼현.html" style="color: #00AA7B; text-decoration: none;">조삼현</a></td>
                                            <td class="member-cell" style="background-color: #ffffff; padding: 8px 4px; border: 1px solid #aaa; font-weight: bold;"><a href="사진함.html" style="color: #1B5B40; text-decoration: none;">사진함</a></td>
...
<span style="opacity: 0.9;">
                    * 2000년 새정치국민회의가 새천년민주당으로 확대 창당됨에 따라 당적 변경.
                    </span>
</div>
    ...
    // 컴포넌트 렌더링 실행
    renderDeokbinnamHead2Nav('deokbinnam-head-2-nav-container');
});