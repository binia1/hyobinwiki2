...
<tr><td rowspan="4" style="border: 1px solid #ccc; padding: 10px; background-color: #64B5F6; font-weight: bold;"><a href="중앙동.html" style="text-decoration: none; color: black;">중앙동</a></td><td style="border: 1px solid #ccc; padding: 10px;">중앙로1가</td><td style="border: 1px solid #ccc; padding: 10px;">중앙로2가</td><td style="border: 1px solid #ccc; padding: 10px;">중앙로3가</td></tr>
