document.addEventListener("DOMContentLoaded", function() {
    function renderHyobinHead8Nav(containerId) {
        ...
        <div class="nav-box shadow-sm" style="border: 1px solid #aaa; margin-bottom: 30px; background-color: #fff; font-family: 'Noto Sans KR', sans-serif;">
            <div class="nav-header tracking-wide" style="background-color: #7777aa; color: white; text-align: center; font-weight: bold; padding: 8px; font-size: 1.05rem;">
                ...
                <span style="display:inline-flex; align-items:center; gap:6px;">
                    ...
                    <a href="효빈광역시.html" style="color:white; text-decoration: none;">효빈광역시 민선 8기 기초자치단체장</a>
                </span>
            </div>
                    ...
                    <table class="nav-table" style="width: 100%; border-collapse: collapse; table-layout: fixed; background-color: #ffffff; text-align: center; font-size: 0.95rem; word-break: keep-all;">
                        <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="member-cell" style="background-color: #ffffff; padding: 8px 4px; border: 1px solid #aaa; font-weight: bold;"><a href="노서현.html" style="color: #003B96; text-decoration: none;">노서현</a></td>
...
<span style="opacity: 0.9;">
                    * 당초 당선된 남구청장 강덕수(국민의힘) 당선무효 <i class="fas fa-arrow-right mx-1 text-xs"></i> <b>보궐선거 오전희(더불어민주당) 당선</b><br/>
                    * 동구청장 조우영 조국혁신당 입당
                    </span>
</div>
    ...
    // 컴포넌트 렌더링 실행
    renderHyobinHead8Nav('hyobin-head-8-nav-container');
});