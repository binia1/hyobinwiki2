document.addEventListener("DOMContentLoaded", function() {
    function renderDeokbinbukAssembly22Nav(containerId) {
        ...
        <div class="nav-box shadow-sm" style="border: 1px solid #aaa; margin-bottom: 30px; background-color: #fff; font-family: 'Noto Sans KR', sans-serif;">
            <div class="nav-header tracking-wide" style="background-color: #4AD898; color: white; text-align: center; font-weight: bold; padding: 8px; font-size: 1.05rem;">
                <span style="display:inline-flex; align-items:center; gap:4px;">
                    ...
                    <a href="덕빈북도.html" style="color:white; text-decoration: none;">덕빈북도 제22대 국회의원</a>
                </span>
            </div>
                    ...
                    <table class="nav-table" style="width: 100%; border-collapse: collapse; table-layout: fixed; background-color: #ffffff; text-align: center; font-size: 0.95rem; word-break: keep-all;">
                        <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="member-cell" style="background-color: #ffffff; padding: 8px 4px; border: 1px solid #aaa; font-weight: bold;"><a href="박현언.html" style="color: #003B96; text-decoration: none;">박현언</a></td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="member-cell" style="background-color: #ffffff; padding: 8px 4px; border: 1px solid #aaa; font-weight: bold;"><a href="김세솔.html" style="color: #003B96; text-decoration: none;">김세솔</a></td>
                                            <td class="member-cell" style="background-color: #ffffff; padding: 8px 4px; border: 1px solid #aaa; font-weight: bold;"><a href="김수연.html" style="color: #003B96; text-decoration: none;">김수연</a></td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="district-cell" style="width: 25%; background-color: #E61E2B; padding: 8px 4px; border: 1px solid #aaa; font-weight: bold;"><a href="전산시·상안군·모제군·서진시.html" style="color: #ffffff; text-decoration: none;">전산시·상안군·모제군·서진시</a></td>
                                            <td class="district-cell" style="width: 25%; background-color: #E61E2B; padding: 8px 4px; border: 1px solid #aaa; font-weight: bold;"><a href="저천군·덕현군·치원군.html" style="color: #ffffff; text-decoration: none;">저천군·덕현군·치원군</a></td>
                                        </tr>
                                        <tr>
                                            <td class="member-cell" style="background-color: #ffffff; padding: 8px 4px; border: 1px solid #aaa; font-weight: bold;"><a href="위서은.html" style="color: #003B96; text-decoration: none;">위서은</a></td>
                                            ...
                                            <td class="member-cell" style="background-color: #ffffff; padding: 8px 4px; border: 1px solid #aaa; font-weight: bold;"><a href="나두길.html" style="color: #E61E2B; text-decoration: none;">나두길</a></td>
                                            <td class="member-cell" style="background-color: #ffffff; padding: 8px 4px; border: 1px solid #aaa; font-weight: bold;"><a href="강동혁.html" style="color: #E61E2B; text-decoration: none;">강동혁</a></td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="district-cell" style="width: 25%; background-color: #D6001C; padding: 8px 4px; border: 1px solid #aaa; font-weight: bold;"><a href="약산시·선곡군 갑.html" style="color: #ffffff; text-decoration: none;">약산시·선곡군 갑</a></td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="member-cell" style="background-color: #ffffff; padding: 8px 4px; border: 1px solid #aaa; font-weight: bold;"><a href="고상철.html" style="color: #003B96; text-decoration: none;">고상철</a></td>
                                            <td class="member-cell" style="background-color: #ffffff; padding: 8px 4px; border: 1px solid #aaa; font-weight: bold;"><a href="소산현.html" style="color: #D6001C; text-decoration: none;">소산현</a></td>
                                        ...
                                        <tr>
                                            <td class="member-cell" style="background-color: #ffffff; padding: 8px 4px; border: 1px solid #aaa; font-weight: bold;"><a href="남소현.html" style="color: #003B96; text-decoration: none;">남소현</a></td>
    ...
    renderDeokbinbukAssembly22Nav('deokbinbuk-assembly-22-nav-container');
});