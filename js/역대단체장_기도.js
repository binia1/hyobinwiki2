...
document.addEventListener("DOMContentLoaded", function() {
    var containers = document.querySelectorAll(".hb-history-기도-0-nav");
...
<tr>
<td class="history-nav-toggle" colspan="5" onclick="toggleHistoryNav_기도_0()">
<span id="history-nav-text-기도-0">[ 펼치기 · 접기 ]</span>
</td>
</tr>
</thead>
<tbody id="history-nav-body-기도-0">
<tr>
...
if (typeof window.toggleHistoryNav_기도_0 === 'undefined') {
    window.toggleHistoryNav_기도_0 = function() {
        var body = document.getElementById("history-nav-body-기도-0");
        var text = document.getElementById("history-nav-text-기도-0");
        if (!body) return;
