document.addEventListener("DOMContentLoaded", function() {
    function render효빈광역시_역대_국회Assembly21Nav(containerId) {
        ...
        <div class="nav-box shadow-sm" style="border: 1px solid #aaa; margin-bottom: 30px; background-color: #fff; font-family: 'Noto Sans KR', sans-serif;">
            <div class="nav-header tracking-wide" style="background-color: #7777AA; color: white; text-align: center; font-weight: bold; padding: 8px; font-size: 1.05rem;">
                <span style="display:inline-flex; align-items:center; gap:4px;">
                    ...
                    <a href="효빈광역시.html" style="color:white; text-decoration: none;">효빈광역시 제21대 국회의원</a>
                </span>
            </div>
            <details  style="width: 100%;">
                ...
                <div style="padding: 0;">
                    <table class="nav-table" style="width: 100%; border-collapse: collapse; table-layout: fixed; background-color: #ffffff; text-align: center; font-size: 0.95rem; word-break: keep-all;">
                        <tbody>
                                        <tr>
                                            <td class="district-cell" style="width: 25%; background-color: #E61E2B; padding: 8px 4px; border: 1px solid #aaa; font-weight: bold;"><a href="남구 갑.html" style="color: #ffffff; text-decoration: none;">남구 갑</a></td>
                                            <td class="district-cell" style="width: 25%; background-color: #003B96; padding: 8px 4px; border: 1px solid #aaa; font-weight: bold;"><a href="남구 을.html" style="color: #ffffff; text-decoration: none;">남구 을</a></td>
                                        ...
                                        <tr>
                                            <td class="member-cell" style="background-color: #ffffff; padding: 8px 4px; border: 1px solid #aaa; font-weight: bold;"><a href="우신면.html" style="color: #E61E2B; text-decoration: none;">우신면</a></td>
                                            <td class="member-cell" style="background-color: #ffffff; padding: 8px 4px; border: 1px solid #aaa; font-weight: bold;"><a href="고정민.html" style="color: #003B96; text-decoration: none;">고정민</a></td>
                                        ...
                                        <tr>
                                            <td class="district-cell" style="width: 25%; background-color: #003B96; padding: 8px 4px; border: 1px solid #aaa; font-weight: bold;"><a href="북구 병.html" style="color: #ffffff; text-decoration: none;">북구 병</a></td>
                                            ...
                                            <td class="district-cell" style="width: 25%; background-color: #003B96; padding: 8px 4px; border: 1px solid #aaa; font-weight: bold;"><a href="안천갑.html" style="color: #ffffff; text-decoration: none;">안천갑</a></td>
                                        </tr>
                                        <tr>
                                            <td class="member-cell" style="background-color: #ffffff; padding: 8px 4px; border: 1px solid #aaa; font-weight: bold;"><a href="이찬대.html" style="color: #003B96; text-decoration: none;">이찬대</a></td>
                                            <td class="member-cell" style="background-color: #ffffff; padding: 8px 4px; border: 1px solid #aaa; font-weight: bold;"><a href="신수인.html" style="color: #003B96; text-decoration: none;">신수인</a></td>
                                            <td class="member-cell" style="background-color: #ffffff; padding: 8px 4px; border: 1px solid #aaa; font-weight: bold;"><a href="도상현.html" style="color: #003B96; text-decoration: none;">도상현</a></td>
                                            <td class="member-cell" style="background-color: #ffffff; padding: 8px 4px; border: 1px solid #aaa; font-weight: bold;"><a href="우성중.html" style="color: #003B96; text-decoration: none;">우성중</a></td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="district-cell" style="width: 25%; background-color: #003B96; padding: 8px 4px; border: 1px solid #aaa; font-weight: bold;"><a href="서구.html" style="color: #ffffff; text-decoration: none;">서구</a></td>
                                        ...
                                        <tr>
                                            <td class="member-cell" style="background-color: #ffffff; padding: 8px 4px; border: 1px solid #aaa; font-weight: bold;"><a href="유산성.html" style="color: #003B96; text-decoration: none;">유산성</a></td>
                                            <td class="member-cell" style="background-color: #ffffff; padding: 8px 4px; border: 1px solid #aaa; font-weight: bold;"><a href="상신고.html" style="color: #003B96; text-decoration: none;">상신고</a></td>
                                            <td class="member-cell" style="background-color: #ffffff; padding: 8px 4px; border: 1px solid #aaa; font-weight: bold;"><a href="추산령.html" style="color: #003B96; text-decoration: none;">추산령</a></td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="district-cell" style="width: 25%; background-color: #003B96; padding: 8px 4px; border: 1px solid #aaa; font-weight: bold;"><a href="동구·중구.html" style="color: #ffffff; text-decoration: none;">동구·중구</a></td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="member-cell" style="background-color: #ffffff; padding: 8px 4px; border: 1px solid #aaa; font-weight: bold;"><a href="김성민.html" style="color: #003B96; text-decoration: none;">김성민</a></td>
    ...
    render효빈광역시_역대_국회Assembly21Nav('효빈광역시_역대_국회-assembly-21-nav-container');
});