document.addEventListener("DOMContentLoaded", function() {
    function renderDeokbinbukAssembly20Nav(containerId) {
        ...
        <div class="nav-box shadow-sm" style="border: 1px solid #aaa; margin-bottom: 30px; background-color: #fff; font-family: 'Noto Sans KR', sans-serif;">
            <div class="nav-header tracking-wide" style="background-color: #4AD898; color: white; text-align: center; font-weight: bold; padding: 8px; font-size: 1.05rem;">
                <span style="display:inline-flex; align-items:center; gap:4px;">
                    ...
                    <a href="덕빈북도.html" style="color:white; text-decoration: none;">덕빈북도 제20대 국회의원</a>
                </span>
            </div>
                ...
                <div style="padding: 0;">
                    <table class="nav-table" style="width: 100%; border-collapse: collapse; table-layout: fixed; background-color: #ffffff; text-align: center; font-size: 0.95rem; word-break: keep-all;">
                        <tbody>
                                        ...
                                        <tr>
                                            <td class="member-cell" style="background-color: #ffffff; padding: 8px 4px; border: 1px solid #aaa; font-weight: bold;"><a href="이성규.html" style="color: #003B96; text-decoration: none;">이성규</a></td>
                                            <td class="member-cell" style="background-color: #ffffff; padding: 8px 4px; border: 1px solid #aaa; font-weight: bold;"><a href="조현석.html" style="color: #003B96; text-decoration: none;">조현석</a></td>
                                        ...
                                        <tr>
                                            <td class="member-cell" style="background-color: #ffffff; padding: 8px 4px; border: 1px solid #aaa; font-weight: bold;"><a href="박정희.html" style="color: #003B96; text-decoration: none;">박정희</a></td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="district-cell" style="width: 25%; background-color: #C9252B; padding: 8px 4px; border: 1px solid #aaa; font-weight: bold;"><a href="전산시·상안군·모제군·서진시.html" style="color: #ffffff; text-decoration: none;">전산시·상안군·모제군·서진시</a></td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="member-cell" style="background-color: #ffffff; padding: 8px 4px; border: 1px solid #aaa; font-weight: bold;"><a href="박상길.html" style="color: #003B96; text-decoration: none;">박상길</a></td>
                                            ...
                                            <td class="member-cell" style="background-color: #ffffff; padding: 8px 4px; border: 1px solid #aaa; font-weight: bold;"><a href="강동혁.html" style="color: #C9252B; text-decoration: none;">강동혁</a></td>
                                        </tr>
                                        <tr>
    ...
    renderDeokbinbukAssembly20Nav('deokbinbuk-assembly-20-nav-container');
});