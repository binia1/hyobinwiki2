/**
 * 파일명: js/복지여자고등학교학교.js
 * 설명: 복지여자고등학교 초/중/고등학교 목록 자동 생성
 */
document.addEventListener("DOMContentLoaded", function() {
    var containers = document.querySelectorAll(".hb-복지여자고등학교-school");
...
<tr>
<td class="bg-girl"><a class="wiki-link" href="당선여자고등학교.html">당선여고</a></td><td class="bg-boy"><a class="wiki-link" href="복지고등학교.html">복지고</a></td><td class="bg-girl" style="border: 2px solid var(--wiki-main) !important; font-weight:bold;"><a class="wiki-link" href="복지여자고등학교.html">복지여고</a></td><td><a class="wiki-link" href="청덕고등학교.html">청덕고</a></td><td><a class="wiki-link" href="효빈대부설고등학교.html">효빈대부설고</a></td>
</tr>
<tr>
