document.addEventListener("DOMContentLoaded", function() {
    function renderHyobinHead6Nav(containerId) {
        ...
        <div class="nav-box shadow-sm" style="border: 1px solid #aaa; margin-bottom: 30px; background-color: #fff; font-family: 'Noto Sans KR', sans-serif;">
            <div class="nav-header tracking-wide" style="background-color: #7777aa; color: white; text-align: center; font-weight: bold; padding: 8px; font-size: 1.05rem;">
                ...
                <span style="display:inline-flex; align-items:center; gap:6px;">
                    ...
                    <a href="효빈광역시.html" style="color:white; text-decoration: none;">효빈광역시 민선 6기 기초자치단체장</a>
                </span>
            </div>
                    ...
                    <table class="nav-table" style="width: 100%; border-collapse: collapse; table-layout: fixed; background-color: #ffffff; text-align: center; font-size: 0.95rem; word-break: keep-all;">
                        <tbody>
                                        <tr>
                                            ...
                                            <td class="district-cell" style="width: 20%; background-color: #C9252B; padding: 8px 4px; border: 1px solid #aaa; font-weight: bold;"><a href="동구.html" style="color: #ffffff; text-decoration: none;">동구</a></td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="member-cell" style="background-color: #ffffff; padding: 8px 4px; border: 1px solid #aaa; font-weight: bold;"><a href="조양현.html" style="color: #C9252B; text-decoration: none;">조양현</a></td>
                                            ...
                                            <td class="member-cell" style="background-color: #ffffff; padding: 8px 4px; border: 1px solid #aaa; font-weight: bold;"><a href="박아밀라.html" style="color: #004EA2; text-decoration: none;">박아밀라</a></td>
                                        ...
                                        <tr>
                                            <td class="member-cell" style="background-color: #ffffff; padding: 8px 4px; border: 1px solid #aaa; font-weight: bold;"><a href="신운연.html" style="color: #004EA2; text-decoration: none;">신운연</a></td>
                                            <td class="member-cell" style="background-color: #ffffff; padding: 8px 4px; border: 1px solid #aaa; font-weight: bold;"><a href="천미남.html" style="color: #004EA2; text-decoration: none;">천미남</a></td>
                                            <td class="member-cell" style="background-color: #ffffff; padding: 8px 4px; border: 1px solid #aaa; font-weight: bold;"><a href="정창훈.html" style="color: #004EA2; text-decoration: none;">정창훈</a></td>
                                            <td class="member-cell" style="background-color: #ffffff; padding: 8px 4px; border: 1px solid #aaa; font-weight: bold;"><a href="심원식.html" style="color: #004EA2; text-decoration: none;">심원식</a></td>
    ...
    // 컴포넌트 렌더링 실행
    renderHyobinHead6Nav('hyobin-head-6-nav-container');
});