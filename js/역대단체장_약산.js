/**
 * 파일명: js/역대단체장_약산.js
 * 설명: 덕빈북도 약산시장 내비게이션 자동 생성
 */
document.addEventListener("DOMContentLoaded", function() {
    var containers = document.querySelectorAll(".hb-history-약산-nav");
...
<tr>
<td class="history-nav-toggle" colspan="5" onclick="toggleHistoryNav_약산()">
<span id="history-nav-text-약산">[ 펼치기 · 접기 ]</span>
</td>
</tr>
</thead>
<tbody id="history-nav-body-약산">
<tr>
...
// 개별 토글 함수 자동 생성
if (typeof window.toggleHistoryNav_약산 === 'undefined') {
    window.toggleHistoryNav_약산 = function() {
        var body = document.getElementById("history-nav-body-약산");
        var text = document.getElementById("history-nav-text-약산");
        if (!body || !text) return;
