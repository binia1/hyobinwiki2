document.addEventListener("DOMContentLoaded", function() {
    function renderDeokbinbukHead7Nav(containerId) {
...
<img src="이미지/덕북로고.webp" alt="덕빈북도 로고" style="height: 40px !important; width: auto; vertical-align: middle; filter: brightness(0) invert(1);">
                    <a href="덕빈북도.html" style="color:white; text-decoration: none;">덕빈북도 민선 7기 기초자치단체장</a>
                </span>
            </div>
                    ...
                    <table class="nav-table" style="width: 100%; border-collapse: collapse; table-layout: fixed; background-color: #ffffff; text-align: center; font-size: 0.95rem; word-break: keep-all;">
                        <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="member-cell" style="background-color: #ffffff; padding: 8px 4px; border: 1px solid #aaa; font-weight: bold;"><a href="박아상.html" style="color: #004EA2; text-decoration: none;">박아상</a></td>
                                            <td class="member-cell" style="background-color: #ffffff; padding: 8px 4px; border: 1px solid #aaa; font-weight: bold;"><a href="김민철.html" style="color: #004EA2; text-decoration: none;">김민철</a></td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="district-cell" style="width: 20%; background-color: #0BA95F; padding: 8px 4px; border: 1px solid #aaa; font-weight: bold;"><a href="전산시.html" style="color: #ffffff; text-decoration: none;">전산시</a></td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="member-cell" style="background-color: #ffffff; padding: 8px 4px; border: 1px solid #aaa; font-weight: bold;"><a href="기서진.html" style="color: #0BA95F; text-decoration: none;">기서진</a></td>
                                            <td class="member-cell" style="background-color: #ffffff; padding: 8px 4px; border: 1px solid #aaa; font-weight: bold;"><a href="유영현.html" style="color: #004EA2; text-decoration: none;">유영현</a></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td class="member-cell" style="background-color: #ffffff; padding: 8px 4px; border: 1px solid #aaa; font-weight: bold;"><a href="조민규.html" style="color: #004EA2; text-decoration: none;">조민규</a></td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="district-cell" style="width: 20%; background-color: #004EA2; padding: 8px 4px; border: 1px solid #aaa; font-weight: bold;"><a href="저천군.html" style="color: #ffffff; text-decoration: none;">저천군</a></td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="member-cell" style="background-color: #ffffff; padding: 8px 4px; border: 1px solid #aaa; font-weight: bold;"><a href="양기현.html" style="color: #004EA2; text-decoration: none;">양기현</a></td>
...
<span style="opacity: 0.9;">
                    * 서진시장 공하진(자유한국당) 당선무효 <i class="fas fa-arrow-right mx-1 text-xs"></i> <b>보궐선거 김철호(국민의힘) 당선</b>
</span>
</div>
    ...
    // 컴포넌트 렌더링 실행
    renderDeokbinbukHead7Nav('deokbinbuk-head-7-nav-container');
});