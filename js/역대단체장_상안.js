/**
 * 파일명: js/역대단체장_상안.js
 * 설명: 덕빈북도 상안군수 내비게이션 자동 생성
 */
document.addEventListener("DOMContentLoaded", function() {
    var containers = document.querySelectorAll(".hb-history-상안-nav");
...
<tr>
<td class="history-nav-toggle" colspan="5" onclick="toggleHistoryNav_상안()">
<span id="history-nav-text-상안">[ 펼치기 · 접기 ]</span>
</td>
</tr>
</thead>
<tbody id="history-nav-body-상안">
<tr>
...
// 개별 토글 함수 자동 생성
if (typeof window.toggleHistoryNav_상안 === 'undefined') {
    window.toggleHistoryNav_상안 = function() {
        var body = document.getElementById("history-nav-body-상안");
        var text = document.getElementById("history-nav-text-상안");
        if (!body || !text) return;
