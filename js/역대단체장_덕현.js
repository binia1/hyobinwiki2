...
document.addEventListener("DOMContentLoaded", function() {
    var containers = document.querySelectorAll(".hb-history-덕현-0-nav");
...
<tr>
<td class="history-nav-toggle" colspan="5" onclick="toggleHistoryNav_덕현_0()">
<span id="history-nav-text-덕현-0">[ 펼치기 · 접기 ]</span>
</td>
</tr>
</thead>
<tbody id="history-nav-body-덕현-0">
<tr>
...
if (typeof window.toggleHistoryNav_덕현_0 === 'undefined') {
    window.toggleHistoryNav_덕현_0 = function() {
        var body = document.getElementById("history-nav-body-덕현-0");
        var text = document.getElementById("history-nav-text-덕현-0");
        if (!body) return;
