document.addEventListener("DOMContentLoaded", function() {
    function render효빈광역시_역대_국회Assembly22Nav(containerId) {
        ...
        <div class="nav-box shadow-sm" style="border: 1px solid #aaa; margin-bottom: 30px; background-color: #fff; font-family: 'Noto Sans KR', sans-serif;">
            <div class="nav-header tracking-wide" style="background-color: #7777AA; color: white; text-align: center; font-weight: bold; padding: 8px; font-size: 1.05rem;">
                <span style="display:inline-flex; align-items:center; gap:4px;">
                    ...
                    <a href="효빈광역시.html" style="color:white; text-decoration: none;">효빈광역시 제22대 국회의원</a>
                </span>
            </div>
                    ...
                    <table class="nav-table" style="width: 100%; border-collapse: collapse; table-layout: fixed; background-color: #ffffff; text-align: center; font-size: 0.95rem; word-break: keep-all;">
                        <tbody>
                                        <tr>
                                            ...
                                            <td class="district-cell" style="width: 25%; background-color: #D6001C; padding: 8px 4px; border: 1px solid #aaa; font-weight: bold;"><a href="남구 을.html" style="color: #ffffff; text-decoration: none;">남구 을</a></td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="member-cell" style="background-color: #ffffff; padding: 8px 4px; border: 1px solid #aaa; font-weight: bold;"><a href="신원임.html" style="color: #D6001C; text-decoration: none;">신원임</a></td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="member-cell" style="background-color: #ffffff; padding: 8px 4px; border: 1px solid #aaa; font-weight: bold;"><a href="소판권.html" style="color: #003B96; text-decoration: none;">소판권</a></td>
                                            <td class="member-cell" style="background-color: #ffffff; padding: 8px 4px; border: 1px solid #aaa; font-weight: bold;"><a href="고선규.html" style="color: #003B96; text-decoration: none;">고선규</a></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td class="member-cell" style="background-color: #ffffff; padding: 8px 4px; border: 1px solid #aaa; font-weight: bold;"><a href="신진영.html" style="color: #003B96; text-decoration: none;">신진영</a></td>
                                            <td class="member-cell" style="background-color: #ffffff; padding: 8px 4px; border: 1px solid #aaa; font-weight: bold;"><a href="지선진.html" style="color: #003B96; text-decoration: none;">지선진</a></td>
                                        ...
                                        <tr>
                                            <td class="member-cell" style="background-color: #ffffff; padding: 8px 4px; border: 1px solid #aaa; font-weight: bold;"><a href="박청권.html" style="color: #003B96; text-decoration: none;">박청권</a></td>
    ...
    render효빈광역시_역대_국회Assembly22Nav('효빈광역시_역대_국회-assembly-22-nav-container');
});