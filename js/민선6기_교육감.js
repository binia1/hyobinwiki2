document.addEventListener("DOMContentLoaded", function() {
                ...
                <table style="width: 100%; border-collapse: collapse; text-align: center; font-size: 0.9em; table-layout: fixed; margin: 0;">
                    <tbody>
                        ...
                        <tr style="color: white; font-weight: bold;">
                            ...
                            <td style="background-color: #777777; padding: 6px; border: 1px solid #ddd;">대구</td>
                            <td style="background-color: #000000; padding: 6px; border: 1px solid #ddd;">인천</td>
                        </tr>
                        <tr style="background-color: #fff;">
                            ...
                            <td style="padding: 10px 5px; border: 1px solid #ddd;"><a href="우동기.html" style="color: #777777; text-decoration: none;">우동기</a></td>
                            <td style="padding: 10px 5px; border: 1px solid #ddd; line-height: 1.3;">
                                <a href="장우삼.html" style="color: #000000; text-decoration: none; font-weight: bold;">장우삼</a><br>
                        ...
                        <tr style="background-color: #fff;">
                            ...
                            <td style="padding: 10px 5px; border: 1px solid #ddd; line-height: 1.3;">
                                <a href="류혜숙.html" style="color: #000000; text-decoration: none; font-weight: bold;">류혜숙</a><br>
                                <span style="display: inline-block; background-color: black; color: white; font-size: 0.75em; padding: 2px 5px; margin-top: 3px; font-weight: bold; border-radius: 1px; letter-spacing: -0.5px;">권한대행</span>
                            </td>
                        ...
                        <tr style="background-color: #fff;">
                            ...
                            <td style="padding: 10px 5px; border: 1px solid #ddd; line-height: 1.3;">
                                <a href="이기봉.html" style="color: #000000; text-decoration: none; font-weight: bold;">이기봉</a><br>
                                <span style="display: inline-block; background-color: black; color: white; font-size: 0.75em; padding: 2px 5px; margin-top: 3px; font-weight: bold; border-radius: 1px; letter-spacing: -0.5px;">권한대행</span>
                            </td>
                        ...
                        <tr style="color: white; font-weight: bold;">
                            ...
                            <td style="background-color: #777777; padding: 6px; border: 1px solid #ddd;">덕남</td>
                        </tr>
                        <tr style="background-color: #fff;">
                            ...
                            <td style="padding: 10px 5px; border: 1px solid #ddd;"><a href="장태산.html" style="color: #777777; text-decoration: none; font-weight: bold;">장태산</a></td>
                        </tr>
                        ...
                        <tr style="background-color: #fff; border-top: 1px solid #ddd;">
                            <td colspan="4" style="padding: 15px; font-size: 0.85em; color: #333; text-align: center; line-height: 1.8;">
                                * 인천광역시교육감 <a href="이청연.html" style="color: #00A3A6; text-decoration: none;">이청연</a> 교육감직 상실 (2017.12.7.)<br>
                                * 울산광역시교육감 <a href="김복만.html" style="color: #E61E8C; text-decoration: none;">김복만</a> 사퇴 (2017.12.31.)<br>
                                * 전라남도교육감 <a href="장만채.html" style="color: #00A3A6; text-decoration: none;">장만채</a> 사퇴 (2018.3.15.)
                            </td>
                        </tr>
                        ...
                        <tr style="background-color: #f8f9fa; border-top: 1px solid #ddd;">
                            <td colspan="4" style="padding: 15px 10px 10px 10px; font-size: 0.85em; color: #555; text-align: center; line-height: 1.6;">
                                <a href="제6회_전국동시지방선거.html" style="color: #0275d8; text-decoration: none;">제6회 전국동시지방선거</a><br/>
    ...
    const container = document.querySelector(".minseon6-edu-nav-container");
    if (container) {
        container.innerHTML = minseon6EduNavHTML;
    }
});