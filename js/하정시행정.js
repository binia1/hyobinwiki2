...
document.addEventListener("DOMContentLoaded", function() {
    ...
    var textColor = "white";
    var containers = document.querySelectorAll(".hb-하정시-nav");

    containers.forEach(function(container, index) {
        var uniqueNavId = "하정시Nav_" + index;
        var uniqueLabelId = "하정시Label_" + index;
            ...
            <div class="nav-header-container-auto" onclick="toggleNav('${uniqueNavId}', '${uniqueLabelId}')">
                <div class="nav-header-top-auto">
                    <div class="nav-header-title-box">
                        <img src="이미지/하정시.webp" alt="로고" style="height: 40px;" onerror="this.src='이미지/hyobin1.webp'">
