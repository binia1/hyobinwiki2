/**
 * 파일명: js/역대단체장_모제.js
 * 설명: 덕빈북도 모제군수 내비게이션 자동 생성
 */
document.addEventListener("DOMContentLoaded", function() {
    var containers = document.querySelectorAll(".hb-history-모제-nav");
...
<tr>
<td class="history-nav-toggle" colspan="5" onclick="toggleHistoryNav_모제()">
<span id="history-nav-text-모제">[ 펼치기 · 접기 ]</span>
</td>
</tr>
</thead>
<tbody id="history-nav-body-모제">
<tr>
...
// 개별 토글 함수 자동 생성
if (typeof window.toggleHistoryNav_모제 === 'undefined') {
    window.toggleHistoryNav_모제 = function() {
        var body = document.getElementById("history-nav-body-모제");
        var text = document.getElementById("history-nav-text-모제");
        if (!body || !text) return;
