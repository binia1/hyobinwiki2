...
document.addEventListener("DOMContentLoaded", function() {
    ...
    const footerHTML = `
        <footer class="mt-20 border-t border-gray-300 dark:border-gray-700 pt-10 pb-10 leading-relaxed wiki-footer">
    ...
    // 기존 HTML의 wiki-footer-area와 파이썬으로 갈아치운 footer-container 모두 감지해서 작동하도록 처리
